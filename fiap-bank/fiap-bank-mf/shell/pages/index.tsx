...
export default function Welcome() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-fiap-gradient p-8">
      <motion.div initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ duration: 0.6 }} className="max-w-2xl w-full fiap-pink backdrop-blur rounded-3xl p-12 text-center">
